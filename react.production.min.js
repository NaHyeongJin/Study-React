...
(function(v, m) {
  ...
  function P(a, b, c, d) {
    ...
    if (Array.isArray(a))
      ...
      (null === a || "object" !== typeof a
        ? (g = null)
        : ((g = (ma && a[ma]) || a["@@iterator"]),
          (g = "function" === typeof g ? g : null)),
      "function" === typeof g)
    )
      for (a = g.call(a), f = 0; !(e = a.next()).done; )
        (e = e.value), (g = b + Q(e, f++)), (p += P(e, g, c, d));
    else if ("object" === e)
      throw ((c = "" + a),
      Error(
        v(
  ...
  function T(a, b) {
    ...
    a: for (;;) {
      var d = Math.floor((c - 1) / 2),
        e = a[d];
      if (void 0 !== e && 0 < E(e, b)) (a[d] = b), (a[c] = e), (c = d);
      else break a;
    }
  }
  function n(a) {
        ...
        a: for (var d = 0, e = a.length; d < e; ) {
          ...
          if (void 0 !== h && 0 > E(h, c))
            void 0 !== k && 0 > E(k, h)
              ? ((a[d] = k), (a[g] = c), (d = g))
              : ((a[d] = h), (a[f] = c), (d = f));
          else if (void 0 !== k && 0 > E(k, c)) (a[d] = k), (a[g] = c), (d = g);
          else break a;
        }
      }
      return b;
  ...
  function G(a) {
    for (var b = n(u); null !== b; ) {
      if (null === b.callback) F(u);
        ...
        F(u), (b.sortIndex = b.expirationTime), T(q, b);
      else break;
      b = n(u);
    }
  }
    ...
    Scheduler: {
      ...
      unstable_scheduleCallback: function(a, b, c) {
        ...
        e > d
          ? ((a.sortIndex = e),
            T(u, a),
            null === n(q) && a === n(u) && (z ? W() : (z = !0), H(U, e - d)))
          : ((a.sortIndex = c), T(q, a), w || I || ((w = !0), A(V)));
        return a;
      },
  ...
  x = {
    ...
    forwardRef: function(a) {
      return { $$typeof: Ea, render: a };
    },
    lazy: function(a) {
      return { $$typeof: Ha, _ctor: a, _status: -1, _result: null };
    },
    memo: function(a, b) {
      return { $$typeof: Ga, type: a, compare: void 0 === b ? null : b };
    },
    ...
    cloneElement: function(a, b, c) {
      ...
      if (null != b) {
        ...
        for (k in b)
          ia.call(b, k) &&
            !ja.hasOwnProperty(k) &&
            (d[k] = void 0 === b[k] && void 0 !== g ? g[k] : b[k]);
      }
      ...
      return { $$typeof: y, type: a.type, key: e, ref: f, props: d, _owner: h };
    },
